...
const Signin = () => {
  ...
  return (
    ...
    <div className="container" style={{display: "flex", justifyContent:"center", alignItems:"center", marginTop: "180px"}}>
      <p className="title">Sign-In Form</p>
      <form onSubmit={onSubmit} className="form">
        <input
          placeholder="Username"
        ...
        <input
          ...
          required
        />
        <select name="role" className="select" value={role} onChange={onChange} required>
          <option value="client">Client</option>
          <option value="admin">Admin</option>
        </select>
        <button type="submit">Sign In</button>
